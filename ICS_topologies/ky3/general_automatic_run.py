...
class DHALSIM(MiniCPS):
    ...
    If automatic is 1 and automatic ddos attack can also be simulated by giving the ddos_attack a flag value of 1
    ...
    def automatic_start(self):
        ...
        # Launching automatically attack
        if ddos_attack == 1:
    ...
    def finish(self):
        ...
        if self.ddos_process:
            self.end_plc_process(self.ddos_process)
