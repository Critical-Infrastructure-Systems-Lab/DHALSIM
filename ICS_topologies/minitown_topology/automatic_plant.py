...
class SimulationControl():
    ...
    def main(self):
        ...
        All the automatic_plant.py scrpits follow the same pattern. They process the arguments, register the method interrupt() to handle SIGINT and SIGTERM signals.p
