...
class WADI(MiniCPS):
    ...
    def automatic_start(self):
        ...
        cmd_string = "python2 automatic_plc.py -n plc2 -w " + str(self.week_index)
        ...
        cmd_string = "python2 automatic_plc.py -n plc1 -w " + str(self.week_index)
        # if self.attack_flag and self.attack_type == "device_attack":
        ...
        #     cmd_string = "../../../attack-experiments/env/bin/python ../../attack_repository/mitm_plc/wadi_mitm_attack.py 192.168.1.20 192.168.1.254 "\
