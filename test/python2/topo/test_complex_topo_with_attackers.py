...
def unmodified_yaml(tmpdir):
    dict = {'plcs': [{'name': 'PLC1', }, {'name': 'PLC2', }, ],
            'network_attacks': [{'name': 'attack1', 'target': 'PLC2'},
                                {'name': 'attack2', 'target': 'PLC2'},
                                {'name': 'attack3', 'target': 'PLC1'},
                                {'name': 'attack4', 'target': 'scada'}, ]}
...
@pytest.mark.parametrize('host1, host2',
                         [('r0', 'r1'), ('r0', 'r2'), ('r0', 'r3'), ('r2', 'PLC1'), ('r3', 'PLC2'),
                          ('r1', 'scada'), ('attack1', 'PLC2'), ('attack1', 'r3'),
                          ('attack2', 'PLC2'),
                          ('attack2', 'r3'), ('attack3', 'PLC1'), ('attack3', 'r2'),
                          ('attack4', 'scada'),
                          ('attack4', 'r1')])
...
@pytest.mark.parametrize('host1, host2',
                         [('r0', 'r1'), ('r0', 'r2'), ('r0', 'r3'), ('r1', 's1'), ('r2', 's2'),
                          ('r3', 's3'), ('s2', 'PLC1'), ('s3', 'PLC2'), ('s3', 'attack1'),
                          ('s3', 'attack2'),
                          ('s2', 'attack3'), ('s1', 'attack4'), ('s1', 'scada')])
...
@pytest.mark.parametrize('host1, host2, mac1, mac2',
                         [('r0', 'r1', 'aa:bb:cc:dd:00:', 'aa:bb:cc:dd:04:'),
                          ...
                          ('s3', 'attack1', '', 'aa:bb:cc:dd:05:'),
                          ('s3', 'attack2', '', 'aa:bb:cc:dd:05:'),
                          ('s2', 'attack3', '', 'aa:bb:cc:dd:05:'),
                          ('s1', 'attack4', '', 'aa:bb:cc:dd:05:'),
...
@pytest.mark.parametrize('server, client, server_ip',
                         [('PLC1', 'r0', '10.0.2.1'), ('PLC2', 'r0', '10.0.3.1'),
                          ...
                          ('PLC1', 'attack1', '10.0.2.1'), ('PLC2', 'attack1', '192.168.1.1'),
                          ('PLC1', 'attack2', '10.0.2.1'), ('PLC2', 'attack2', '192.168.1.1'),
                          ('PLC1', 'attack3', '192.168.1.1'), ('PLC2', 'attack3', '10.0.3.1'),
                          ('PLC1', 'attack4', '10.0.2.1'), ('PLC2', 'attack4', '10.0.3.1')])
@pytest.mark.flaky(max_runs=3)
