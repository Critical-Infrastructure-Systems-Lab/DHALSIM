...
def patched_plc(mocker):
    ...
    mocker.patch.object(GenericPLC, "DB_SLEEP_TIME", 1.5)
    ...
    return plc, cur_mock, conn_mock, logger_mock, sleeper


def test_get_master_clock_first_try(patched_plc):
    plc, cur_mock, conn_mock, logger_mock, sleeper = patched_plc
